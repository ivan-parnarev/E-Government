...
import { getCampaigns } from '../../redux/campaigns/campaignsSlice';
...
export default function UserProfileComponent() {
    const filteredCampaigns = useSelector(getCampaigns);
                ...
                <div className={styles['user-info-wrapper']}>
                    <div className={styles['core-data']}>
                        <p className={styles['username']}>
                            <span className={styles['name-wrapper']}>Име:</span>Пешо Пешов
                        </p>
                        <p className={styles['birth-date']}>
                            <span className={styles['birth-date-wrapper']}>Дата на раждане:</span>
                            10/10/1996
                        </p>
                        <p className={styles['gender']}>
                            <span className={styles['gender-wrapper']}>Пол:</span>Мъж
                        </p>
                    </div>
                    <div className={styles['secondary-data']}>
                        <p className={styles['country']}>
                            <span className={styles['country-wrapper']}>Страна:</span>България
                        </p>
                        <p className={styles['city']}>
                            <span className={styles['city-wrapper']}>Град:</span>София
                        </p>
                        <p className={styles['phone-number']}>
                            <span className={styles['phone-number-wrapper']}>Телефон:</span>
                            0001112223
                        </p>
                    </div>
                </div>
